...
class CarbonIsHolidayTest extends TestCase
{
	...
	{
		$this->assertTrue($date->isHoliday());
	}

	/** @test */
	public function we_can_check_for_not_liberation_day()
	{
		$date = Carbon::parse('2021-05-05');
	...
	public function holidays()
	{
		return [
			...
			[Carbon::parse('2020-05-05')], // Bevreidingsdag 2021
